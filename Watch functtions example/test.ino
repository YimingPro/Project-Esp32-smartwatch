...
void setup() {
  ...
  delay(10);
  display.clear();
  display.drawString( 30, 0, "Connection");
  display.setFont(ArialMT_Plain_10);
  display.drawString( 0, 16, "Buzzer-32,RGB-33");
  display.drawString( 0, 26, "Up-5,Down-19,Mid-18");
  display.drawString( 0, 36, "ButtonA-22,ButtonB-23");
  display.drawString( 0, 46, "Flashlight-27");
  display.display();
