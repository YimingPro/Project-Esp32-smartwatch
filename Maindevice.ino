    ...
    if (tft.touched()) {          //Verify the touched are
     ...
     if (tx > 280 && tx < 300 && ty > 430 && ty < 500){
         ...
         delay(100); 
            ...
            tft.drawChar(510, 300, 'T', CHARCOL, CHARBACK, 2); //i cannot comfirm these chars position in screen, i dont have screen
            tft.drawChar(530, 300, 'A', CHARCOL, CHARBACK, 2);
            tft.drawChar(550, 300, 'K', CHARCOL, CHARBACK, 2);
            tft.drawChar(570, 300, 'E', CHARCOL, CHARBACK, 2);
           
            tft.drawChar(590, 300, ' ', CHARCOL, CHARBACK, 2);
  
            tft.drawChar(160, 300, 'P', CHARCOL, CHARBACK, 2);
            tft.drawChar(180, 300, 'I', CHARCOL, CHARBACK, 2);
            tft.drawChar(200, 300, 'L', CHARCOL, CHARBACK, 2);
            tft.drawChar(220, 300, 'L', CHARCOL, CHARBACK, 2);
            tft.drawChar(240, 300, 'S', CHARCOL, CHARBACK, 2);
        ...
        if  (tx > 600 && tx < 700 && ty > 390 && ty < 500){
          ...
          Serial.print("You are touching botton 2 ");
           ...
           btn2.drawButton(); 
            ...
            tft.drawChar(510, 300, 'T', CHARCOL, CHARBACK, 2); 
            tft.drawChar(530, 300, 'A', CHARCOL, CHARBACK, 2);
            tft.drawChar(550, 300, 'K', CHARCOL, CHARBACK, 2);
            tft.drawChar(570, 300, 'E', CHARCOL, CHARBACK, 2);
